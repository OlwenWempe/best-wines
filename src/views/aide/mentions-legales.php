<section class="my-5 container">
    <div>
        ...
        <p>
            Ce site (www.bestwines.fr) est proposé en différents langages web (HTML, HTML5, Javascript, CSS, etc…) pour
            un
            ...
            Google
            Chrome, etc…
            L'agence web Best Wines met en œuvre tous les moyens dont elle dispose, pour assurer une information fiable
            et
    ...
    <div>
        <h2>Cookies :</h2>
        <p>
            Le site www.bestwines.fr peut-être amené à vous demander l'acceptation des cookies pour des besoins de
            statistiques
            ...
            serveur
            accède pour lire et enregistrer des informations . Certaines parties de ce site ne peuvent être
            fonctionnelles
            sans
            ...
            ressources disponibles sur Internet. Best Wines ne dispose d'aucun moyen pour contrôler les sites en
            connexion
            avec
            ses sites
            internet.
            Best Wines ne répond pas de la disponibilité de tels sites et sources externes, ni ne la garantit. Elle ne
            peut
            être
            tenue pour responsable de tout dommage, de quelque nature que ce soit, résultant du contenu de ces sites ou
            sources
            externes, et notamment des informations, produits ou services qu'ils proposent, ou de tout usage qui peut
            être
            fait
            de ces éléments. Les risques liés à cette utilisation incombent pleinement à l'internaute, qui doit se
            conformer
            à
            leurs
            ...
            des
            sites
            internet de Best Wines, il lui appartiendra d'adresser un email accessible sur le site afin de formuler sa
            demande
            de
